/*
  ...
  while connected tp AP http://smartwatch.local
  Masum Ahmed Ma786@kent.ac.uk
  Verson 1.17 Smart Watch Code
*/
...
const char *ssid = "SmartStick APWatch"; // The name of the Wi-Fi network that will be created
const char *password = "SmartStick786";   // The password required to connect to it, leave blank for an open network
const char* host = "smartwatch";
const char *OTAName = "Smartwatch";           // A name and a password for the OTA service
...
//takes action depending on what code has been recived
...
void startWiFi() {
  ...
  wifiMulti.addAP("SmartStick APStick", "SmartStick786");
